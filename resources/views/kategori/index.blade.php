    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mt-10">
        ...
        @if($kategori->count() > 0)
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-3 ">
                    <a href="{{ asset('uploads/'. $rs->photo) }}" target="_blank"><img src="{{ asset('uploads/'. $rs->photo) }}" alt="" class="w-30 h-20"></a>
                </td>
                <td class="py-5 space-x-8 flex">
                    <a href="{{ route('kategori.edit', $rs->id) }}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm text-center py-2 w-16">Edit</a>
