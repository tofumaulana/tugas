<x-app-layout>
  <x-slot name="header">
    <h2 class="text-xl font-semibold leading-tight text-gray-800">
      ...
      {!! __('Edit &raquo; Penulis &raquo;   ') . $penulis->name . '  #' . $penulis->id  !!}
    </h2>
  </x-slot>
  ...
  <div class="py-12">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div>
        ...
        @endif
        <form class="w-full" action="{{ route('penulis/update', $penulis->id )}}" method="post" enctype="multipart/form-data">
          @csrf
          @method('put')
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <input value="{{ old('name') ?? $penulis->name }}" name="name"
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <div class="relative flex">      
                 <input type="text" id="slug" value="{{ old('slug') ?? $penulis->slug }}" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"  required />
          ...
          <div class="">
            <img style="max-width:200px;max-height:200px" id="preview" src="{{ url('photo').'/'.$penulis->photo }}" >           
          </div>
          @endif
...
<script>
  function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.src = '{{ asset('photo/' . $penulis->photo) }}';
            }
        }
